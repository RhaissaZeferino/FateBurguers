...
--
-- Host: localhost
-- Tempo de geração: 08-Dez-2021 às 02:29
...
INSERT INTO `pedido` (`codigoPedido`, `nomePedido`, `lanchePedido`, `bebidaPedido`, `bebidaGeladaPedido`, `bebidaTipoPedido`, `adicionalPedido`, `adicionalListaPedido`, `dataPedido`, `observacoesPedido`, `totalPedido`) VALUES
(0, 'Rhaissa', 'Coxinha', 1, 0, 'Sprite', 1, 'Mostarda', '2021-12-09', 'TESTE', 5);
...
ALTER TABLE `pedido`
  MODIFY `codigoPedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
COMMIT;

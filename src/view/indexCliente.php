...
<table class="table table-hover">
  ...
  <tbody>
    <?php 
        while($objadi = $dados->fetch_object()){    
    ?> 
    <tr>
      <th scope="row"><?php echo $objadi->codigo;?></th>
      <td><?php echo $objadi->nome;?></td>
      <td><?php echo $objadi->endereco;?></td>
      <td><?php echo $objadi->telefone;?></td>
      <td> 
      <a href="editarCliente.php?id=<?php echo $objadi->codigo?>&acao=editar">  

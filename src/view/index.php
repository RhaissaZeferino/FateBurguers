                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item active">
                                    ...
                                    <a class="nav-link" id="botaoFecharPedido" href="index.php">Novo</a>
                                ...
                                <li class="nav-item">
                                    <button class="nav-link btn" href="#"onclick="<?php $acao='excluir';?>" type="submit" name="submit" value="Submit">Salvar</button>
                                </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <fieldset class="border p-2">
                                ...
                                ?>
                                    ...
                                    <input type="checkbox" name="adicionalListaPedido" value="<?php echo $objAdicional->codigo; ?>" id="<?php echo $objAdicional->descricao; ?>">
                        ...
                        <div class="col-md-12">
                            <fieldset class="border p-2">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" id="observacoesPedido" value="observacoesPedido" name="observacoesPedido" rows="3" placeholder="Observações"></textarea>
                                </div>
                    ...
                    <fieldset class="border p-2">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                ...
                                <!-- <p><?php //echo $objPedido->CodigoPedido;
                                        ?></p> -->
